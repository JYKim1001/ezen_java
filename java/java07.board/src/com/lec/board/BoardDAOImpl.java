...
public class BoardDAOImpl implements BoardDAOService {
	...
	private BoardVO inputBoard() {
		...
		String subject = JOptionPane.showInputDialog("글 제목을 입력하세요!");
		String writer = JOptionPane.showInputDialog("작성자를 입력하세요!");
		String content = JOptionPane.showInputDialog("글 내용을 입력하세요!");
	...
	public void updateBoard(int bno) {
		...
		String subject = JOptionPane.showInputDialog("수정할 글제목을 입려하세요!", board.getSubject());
		String content = JOptionPane.showInputDialog("수정할 글내용을 입려하세요!", board.getContent());
