...
public class RobotMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("CheapRobot의 재고 수량 = " + cheapRobot.qty);
		System.out.println();
		...
		System.out.println("StandardRobot의 재고 수량 = " + standardRobot.qty);
		System.out.println();
		...
		System.out.println("SuperRobot의 재고 수량 = " + superRobot.qty);
		System.out.println();
